...
public class W_SDF_GetResourceInventory implements IAFState {
	@Override
	public ECDialogue doAction(AbstractAF abstractAF, InstanceData ec02Ins, List<EquinoxRawData> equinoxRawDatas) {

//		AFLog.d("==================================================================================");
//		AFLog.d("     Start and Set mainTimeStampIncoming : W_SDF_GetResourceInventory");
//		AFLog.d("==================================================================================");
...
//		AFLog.d("==================================================================================");
		...
		for (String key : subInstancekeys) {
			...
			if (afSubIns.getSubNextState().equals(ESubState.END.toString()) && afSubIns.getSubCountChild() == 0) {
...
//		AFLog.d("==================================================================================");
	...
	public ECDialogue start(AbstractAF abstractAF, InstanceData instance, List<EquinoxRawData> eqxRawDataList) {
		EquinoxPropertiesAF outGoingEquinoxPropertiesAF = AFDataFactory.createEquinoxProperties(EState.IDLE, "0");
//		AFLog.d("************************************************************");
//		AFLog.d("START");
//		AFLog.d("************************************************************");
	...
	public ECDialogue doAged(AbstractAF arg0, InstanceData arg1, List<EquinoxRawData> arg2) {
		EquinoxPropertiesAF outGoingEquinoxPropertiesAF = AFDataFactory.createEquinoxProperties(EState.IDLE, "0");
//		AFLog.d("************************************************************");
//		AFLog.d("NO Flow : Aged >> send reject acknowledge to HRZ");
//		AFLog.d("************************************************************");
		return AFDataFactory.createECDialogue(outGoingEquinoxPropertiesAF);
	}
	...
	public ECDialogue doShutdown(AbstractAF arg0, InstanceData arg1, List<EquinoxRawData> arg2) {
		// TODO send reject acknowledge to HRZ
		EquinoxPropertiesAF outGoingEquinoxPropertiesAF = AFDataFactory.createEquinoxProperties(EState.IDLE, "0");
//		AFLog.d("************************************************************");
//		AFLog.d("NO Flow : Shutdown >> send reject acknowledge to HRZ");
//		AFLog.d("************************************************************");
		return AFDataFactory.createECDialogue(outGoingEquinoxPropertiesAF);
	}
...
//    	AFLog.d("==================================================================================");
        AFLog.d("Timeout (ret 4) Received");
//        AFLog.d("==================================================================================");

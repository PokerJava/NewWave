...
public class W_CLIENT_PostResult implements IAFState {
	@Override
	public ECDialogue doAction(AbstractAF abstractAF, InstanceData ec02Ins, List<EquinoxRawData> equinoxRawDatas) {

//		AFLog.d("==================================================================================");
//		AFLog.d("     Start and Set mainTimeStampIncoming : W_CLIENT_PostResult");
//		AFLog.d("==================================================================================");

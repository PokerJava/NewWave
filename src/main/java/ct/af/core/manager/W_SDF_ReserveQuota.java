...
public class W_SDF_ReserveQuota implements IAFState {
	@Override
    public ECDialogue doAction (AbstractAF abstractAF, InstanceData ec02Ins, List<EquinoxRawData> equinoxRawDatas) {

//        AFLog.d("==================================================================================");
//        AFLog.d("     Start and Set mainTimeStampIncoming : W_SDF_ReserveQuota");
//        AFLog.d("==================================================================================");
...
//        AFLog.d("==================================================================================");
    ...
    @Override
    public ECDialogue doAged(AbstractAF abstractAF, InstanceData instanceData, List<EquinoxRawData> list) {
        return null;
    }

    @Override
    public ECDialogue doShutdown(AbstractAF abstractAF, InstanceData instanceData, List<EquinoxRawData> list) {
        return null;
    }
...
//        AFLog.d("==================================================================================");
//        AFLog.d("     If Timeout (ret 4) Handle");
//        AFLog.d("==================================================================================");
